  ...
  return (
    <AuthLayout>
      ...
      <div className="mt-6 grid grid-cols-2 gap-2">
        <Button variant="outline" type="button" onClick={handleGithubRegister}><Github className="mr-2 h-4 w-4" /> GitHub</Button>
        <Button variant="outline" type="button" onClick={handleGoogleRegister}><Mail className="mr-2 h-4 w-4" /> Google</Button>
      </div>
